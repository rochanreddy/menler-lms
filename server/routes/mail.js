...
import { isMailConfigured, transportFor, sendMail } from '../utils/email.js';
import {
...
router.get('/', async (_req, res) => {
  ...
  res.json({
    mail: {
      ...
      // What an admin mail will actually go out on - Resend first, see transportFor().
      provider: transportFor() || 'none',
    },
